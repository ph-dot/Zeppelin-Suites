...
<div class="flex h-175 w-full">
    ...
    <div class="w-full flex flex-col items-center justify-center">
        ...
        <form class="md:w-96 w-80 flex flex-col items-center justify-center">
            ...
            <div class="flex items-center mt-8 w-full bg-transparent border border-black h-12 rounded-full overflow-hidden pl-6 gap-2">
            ...
            <div class="flex items-center mt-6 w-full bg-transparent border border-black h-12 rounded-full overflow-hidden pl-6 gap-2">
                ...
                <input type="password" placeholder="Re-enter Password" class="bg-transparent text-gray-500/80 placeholder-gray-500/80 outline-none text-sm w-full h-full" required>
            </div>
            ...
            <p class="text-gray-500/90 text-sm mt-4">Already have an account? <a class="text-black hover:underline" href="../generalViewPages/login.php">Log In</a></p>
        </form>
    </div>
</div>
