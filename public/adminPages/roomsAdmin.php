...
<aside class="sidebar fixed left-0 top-0 h-full border-r border-slate-100/80 flex flex-col z-50 md:z-40 shadow-2xl md:shadow-none" id="sidebar">
  ...
  <nav class="flex-1 px-2 py-4 space-y-0.5 overflow-y-auto overflow-x-hidden">
    ...
    <a href="../adminPages/roomsAdmin.php" data-tooltip="Rooms" class="sidebar-link active flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-slate-500">
    ...
    <a href="../adminPages/maintenance.html" data-tooltip="Maintenance" class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-slate-500">
...
<div class="main-wrapper h-screen flex flex-col" id="mainWrapper">
    ...
    <div class="flex items-center gap-2 ml-auto">
      <div class="relative" id="profileWrapper">
        ...
        <div class="profile-dropdown absolute right-0 top-full mt-2 w-48 bg-white backdrop-blur-xl border border-slate-200 rounded-2xl shadow-2xl py-2 z-50 hidden" id="profileDropdown">
          <a href="account.php" class="flex items-center gap-3 px-4 py-2.5 text-sm text-slate-700 hover:bg-slate-50 transition-colors rounded-xl mx-1"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>Account Settings</a>
  ...
  <div class="content-area flex-1 max-w-screen-2xl mx-auto w-full mobile-scroll-wrap" id="contentArea">
    ...
    <div class="col-scroll flex-1 min-w-0 p-4 md:p-6 space-y-4">

      <!-- Page title + filters -->
      <div class="flex items-center justify-between flex-wrap gap-3">
        <h1 class="text-xl font-bold text-slate-900">Rooms</h1>
        <div class="flex items-center gap-2">
          <select class="zep-select text-sm border border-slate-200 rounded-full px-3 py-2 bg-white text-slate-600 cursor-pointer transition-all">
          ...
          <select class="zep-select text-sm border border-slate-200 rounded-full px-3 py-2 bg-white text-slate-600 cursor-pointer transition-all">
            <option>All Status</option><option>Allocated</option><option>Not Allocated</option>
          </select>
        </div>
      </div>

      <!-- Rooms table — proper <table> for accessibility & alignment -->
      <div class="bg-white rounded-2xl border border-slate-100 overflow-hidden">
        <div class="overflow-x-auto">
          <table class="w-full text-sm" style="min-width:600px">
            <thead>
              <tr class="border-b border-slate-100 bg-slate-50/60">
                <th class="text-left px-4 py-3 text-xs font-semibold text-slate-400 uppercase tracking-wide w-20">Image</th>
                <th class="text-left px-4 py-3 text-xs font-semibold text-slate-400 uppercase tracking-wide">Unit Details</th>
                <th class="text-left px-4 py-3 text-xs font-semibold text-slate-400 uppercase tracking-wide">Rate</th>
                <th class="text-left px-4 py-3 text-xs font-semibold text-slate-400 uppercase tracking-wide">Status</th>
                <th class="text-right px-4 py-3 text-xs font-semibold text-slate-400 uppercase tracking-wide w-20">Action</th>
              </tr>
            </thead>
            <tbody class="divide-y divide-slate-50">
              ...
              <tr class="room-row">
                <td class="px-4 py-3.5">
                  <div class="w-14 h-11 rounded-xl shrink-0" style="background:linear-gradient(135deg,#dbeafe,#bfdbfe)"></div>
                </td>
                <td class="px-4 py-3.5">
                  <p class="text-xs font-mono text-slate-400 leading-none">Unit Number</p>
                  <p class="text-sm font-semibold text-slate-800 mt-0.5">Unit Name</p>
                  <p class="text-xs text-slate-400">Unit Desc</p>
                  <span class="inline-block mt-1 text-xs font-bold text-amber-500">Unit Desc</span>
                </td>
                <td class="px-4 py-3.5 whitespace-nowrap font-semibold text-slate-800" style="font-family:'DM Mono',monospace">$XXXX.XX<span class="text-xs font-normal text-slate-400">/Day</span></td>
                <td class="px-4 py-3.5"><span class="text-xs font-semibold text-emerald-600 bg-emerald-50 px-2.5 py-1 rounded-full border border-emerald-100">Allocated</span></td>
                <td class="px-4 py-3.5">
                  <div class="flex items-center justify-end gap-1.5">
                    <button class="btn-press p-1.5 rounded-lg hover:bg-slate-100 active:scale-95 text-slate-500 hover:text-slate-800 transition-all"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"/></svg></button>
                    <button class="btn-press p-1.5 rounded-lg hover:bg-red-50 active:scale-95 text-slate-400 hover:text-red-500 transition-all"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/></svg></button>
                  </div>
                </td>
              </tr>
              ...
              <!-- Row 2 -->
              <tr class="room-row">
                <td class="px-4 py-3.5"><div class="w-14 h-11 rounded-xl shrink-0" style="background:linear-gradient(135deg,#d1fae5,#a7f3d0)"></div></td>
                <td class="px-4 py-3.5">
                  <p class="text-xs font-mono text-slate-400 leading-none">Unit Number</p>
                  <p class="text-sm font-semibold text-slate-800 mt-0.5">Unit Name</p>
                  <span class="inline-block mt-1 text-xs font-bold text-blue-500">Unit Desc</span>
                </td>
                <td class="px-4 py-3.5 whitespace-nowrap font-semibold text-slate-800" style="font-family:'DM Mono',monospace">$XXXX.XX<span class="text-xs font-normal text-slate-400">/Day</span></td>
                <td class="px-4 py-3.5"><span class="text-xs font-semibold text-emerald-600 bg-emerald-50 px-2.5 py-1 rounded-full border border-emerald-100">Allocated</span></td>
                <td class="px-4 py-3.5"><div class="flex items-center justify-end gap-1.5"><button class="btn-press p-1.5 rounded-lg hover:bg-slate-100 active:scale-95 text-slate-500 hover:text-slate-800 transition-all"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"/></svg></button><button class="btn-press p-1.5 rounded-lg hover:bg-red-50 active:scale-95 text-slate-400 hover:text-red-500 transition-all"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/></svg></button></div></td>
              </tr>

              <!-- Row 3 -->
              <tr class="room-row">
                <td class="px-4 py-3.5"><div class="w-14 h-11 rounded-xl shrink-0" style="background:linear-gradient(135deg,#fef3c7,#fde68a)"></div></td>
                <td class="px-4 py-3.5">
                  <p class="text-xs font-mono text-slate-400 leading-none">Unit Number</p>
                  <p class="text-sm font-semibold text-slate-800 mt-0.5">Unit Name</p>
                  <p class="text-xs text-slate-400">Unit Desc</p>
                  <span class="inline-block mt-1 text-xs font-bold text-violet-600">Unit Desc</span>
                </td>
                <td class="px-4 py-3.5 whitespace-nowrap font-semibold text-slate-800" style="font-family:'DM Mono',monospace">$XXXX.XX<span class="text-xs font-normal text-slate-400">/Day</span></td>
                <td class="px-4 py-3.5"><span class="text-xs font-semibold text-slate-500 bg-slate-100 px-2.5 py-1 rounded-full border border-slate-200">Not Allocated</span></td>
                <td class="px-4 py-3.5"><div class="flex items-center justify-end gap-1.5"><button class="btn-press p-1.5 rounded-lg hover:bg-slate-100 active:scale-95 text-slate-500 hover:text-slate-800 transition-all"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"/></svg></button><button class="btn-press p-1.5 rounded-lg hover:bg-red-50 active:scale-95 text-slate-400 hover:text-red-500 transition-all"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/></svg></button></div></td>
              </tr>

              <!-- Row 4 -->
              <tr class="room-row">
                <td class="px-4 py-3.5"><div class="w-14 h-11 rounded-xl shrink-0" style="background:linear-gradient(135deg,#ffe4e6,#fecdd3)"></div></td>
                <td class="px-4 py-3.5">
                  <p class="text-xs font-mono text-slate-400 leading-none">Unit Number</p>
                  <p class="text-sm font-semibold text-slate-800 mt-0.5">Unit Name</p>
                  <span class="inline-block mt-1 text-xs font-bold text-purple-600">Unit Desc</span>
                </td>
                <td class="px-4 py-3.5 whitespace-nowrap font-semibold text-slate-800" style="font-family:'DM Mono',monospace">$XXXX.XX<span class="text-xs font-normal text-slate-400">/Day</span></td>
                <td class="px-4 py-3.5"><span class="text-xs font-semibold text-emerald-600 bg-emerald-50 px-2.5 py-1 rounded-full border border-emerald-100">Allocated</span></td>
                <td class="px-4 py-3.5"><div class="flex items-center justify-end gap-1.5"><button class="btn-press p-1.5 rounded-lg hover:bg-slate-100 active:scale-95 text-slate-500 hover:text-slate-800 transition-all"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"/></svg></button><button class="btn-press p-1.5 rounded-lg hover:bg-red-50 active:scale-95 text-slate-400 hover:text-red-500 transition-all"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/></svg></button></div></td>
              ...
              <!-- Row 5 -->
              <tr class="room-row">
                <td class="px-4 py-3.5"><div class="w-14 h-11 rounded-xl shrink-0" style="background:linear-gradient(135deg,#e0f2fe,#bae6fd)"></div></td>
                <td class="px-4 py-3.5">
                  <p class="text-xs font-mono text-slate-400 leading-none">Unit Number</p>
                  <p class="text-sm font-semibold text-slate-800 mt-0.5">Unit Name</p>
                  <span class="inline-block mt-1 text-xs font-bold text-blue-500">Unit Desc</span>
              ...
              <!-- Row 6 -->
              <tr class="room-row">
                <td class="px-4 py-3.5"><div class="w-14 h-11 rounded-xl shrink-0" style="background:linear-gradient(135deg,#f0fdf4,#bbf7d0)"></div></td>
                <td class="px-4 py-3.5">
                  <p class="text-xs font-mono text-slate-400 leading-none">Unit Number</p>
                  <p class="text-sm font-semibold text-slate-800 mt-0.5">Unit Name</p>
                  <span class="inline-block mt-1 text-xs font-bold text-blue-500">Unit Desc</span>
        ...
        <!-- Table pagination -->
        <div class="flex items-center justify-end px-4 py-3.5 border-t border-slate-100 gap-1">
          ...
          <button class="btn-press w-8 h-8 flex items-center justify-center rounded-lg border border-slate-200 text-xs font-medium hover:bg-slate-50 transition-all active:scale-95">9</button>
          <button class="btn-press w-8 h-8 flex items-center justify-center rounded-lg border border-slate-200 text-xs font-medium hover:bg-slate-50 transition-all active:scale-95">10</button>
    ...
    <div class="col-scroll w-full lg:w-80 xl:w-96 shrink-0 p-4 md:p-6 lg:pl-0">
      <div class="bg-white rounded-2xl border border-slate-100 p-5 space-y-4">
        <h2 class="font-bold text-slate-900 text-base">Add a Room</h2>

        <!-- Room Type + Room No -->
        <div class="grid grid-cols-2 gap-3">
          <div>
            <label class="text-xs font-semibold text-slate-500 mb-1.5 block">Room Type</label>
            <select class="zep-select w-full text-sm border border-blue-400 bg-blue-50 text-blue-700 font-medium rounded-full px-3 py-2.5 cursor-pointer transition-all">
          ...
          <div>
            <label class="text-xs font-semibold text-slate-500 mb-1.5 block">Room No.</label>
            <input type="text" value="#" class="zep-input w-full text-sm border border-slate-200 rounded-full px-3 py-2.5 bg-white text-slate-700 transition-all">
          </div>
        </div>

        <!-- Room Name -->
        <div>
          <label class="text-xs font-semibold text-slate-500 mb-1.5 block">Room Name</label>
          <input type="text" value="" class="zep-input w-full text-sm border border-slate-200 rounded-full px-4 py-2.5 bg-white text-slate-700 transition-all">
        </div>

        <!-- Rate -->
        <div>
          <label class="text-xs font-semibold text-slate-500 mb-1.5 block">Rate</label>
          <input type="text" value="$xxxx.xx / Day" class="zep-input w-full text-sm border border-slate-200 rounded-full px-4 py-2.5 bg-white text-slate-700 transition-all">
        </div>

        <!-- Facilities list -->
        <div>
          <button onclick="toggleFacilities()" class="w-full flex items-center justify-between text-sm font-semibold text-slate-700 border border-slate-200 rounded-full px-4 py-2.5 hover:bg-slate-50 transition-all btn-press active:scale-95">
            <span>Facilities list</span>
            <svg class="fac-chevron w-4 h-4 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
          </button>
          <div class="facilities-panel mt-2 space-y-2 px-1" id="facilitiesPanel">
            <label class="flex items-center gap-2 text-xs text-slate-600 cursor-pointer"><input type="checkbox" checked class="w-3.5 h-3.5 rounded accent-blue-600"> Accomodation 1</label>
            <label class="flex items-center gap-2 text-xs text-slate-600 cursor-pointer"><input type="checkbox" class="w-3.5 h-3.5 rounded accent-blue-600"> Accomodation 2</label>
            <label class="flex items-center gap-2 text-xs text-slate-600 cursor-pointer"><input type="checkbox" class="w-3.5 h-3.5 rounded accent-blue-600"> Accomodation 3</label>
            <label class="flex items-center gap-2 text-xs text-slate-600 cursor-pointer"><input type="checkbox" class="w-3.5 h-3.5 rounded accent-blue-600"> Accomodation 4</label>
          </div>
        </div>

        <!-- Upload -->
        <div>
          <label class="text-xs font-semibold text-slate-500 mb-1.5 block">Upload</label>
          <div class="upload-zone rounded-2xl p-6 text-center cursor-pointer" onclick="document.getElementById('fileInput').click()">
            <svg class="w-8 h-8 text-blue-400 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12"/></svg>
            <p class="text-sm text-blue-500 font-semibold">Click to Upload <span class="text-slate-400 font-normal">or drag and drop</span></p>
            <p class="text-xs text-slate-400 mt-0.5">(Max. File size: 25 MB)</p>
            <input type="file" id="fileInput" class="hidden" accept="image/*">
          </div>
          <!-- In-progress upload example -->
          <div class="mt-3 p-3 border border-slate-200 rounded-xl space-y-2">
            <div class="flex items-center justify-between">
              <div class="flex items-center gap-2">
                ...
                <div>
                  <p class="text-xs font-semibold text-slate-700">Room Image 1.jpeg</p>
                  <p class="text-xs text-slate-400">200 KB</p>
                </div>
              </div>
              <button class="btn-press p-1 rounded-lg hover:bg-red-50 text-slate-400 hover:text-red-500 transition-all active:scale-95"><svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/></svg></button>
            </div>
            <div class="w-full bg-slate-100 rounded-full h-1.5">
              <div class="bg-blue-500 h-1.5 rounded-full" style="width:40%"></div>
            </div>
            <p class="text-xs text-slate-400 text-right">40%</p>
          </div>
        </div>

        <!-- Footer buttons -->
        <div class="grid grid-cols-2 gap-3 pt-1">
          <button class="btn-press py-2.5 border border-slate-200 text-slate-600 text-sm font-semibold rounded-full hover:bg-slate-50 hover:border-slate-300 transition-all active:scale-95">Save as Draft</button>
          <button class="btn-press py-2.5 bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold rounded-full transition-all active:scale-95">Add Unit</button>
        </div>
      </div>
    </div><!-- /right col -->
