...
try {
    ...
    if ($action === 'decline') {
        ...
        if ($pendingCount === 0) {
            // Don't close the inquiry out just because this batch of
            // requests is done - only do that once there are truly no
            // other owners/units left the admin could still try.
            ...
            // else: leave approval_status as 'requested' - the admin
            // dashboard shows this as "owner(s) declined, others still
            // available" and lets the admin resend without the request
            // ever showing as fully closed.
        }
