    ...
    <div class="max-w-screen-2xl mx-auto space-y-6">
      ...
      <div class="flex items-center justify-between flex-wrap gap-3">
        ...
        <div class="flex items-center gap-2">
          ...
          <div class="flex bg-slate-100 rounded-full p-1 gap-1">
            <button id="viewTable" onclick="setView('table')" class="btn-press px-3 py-1.5 text-xs font-semibold rounded-full bg-white text-slate-700 shadow-sm active:scale-95 transition-all">
              <svg class="w-3.5 h-3.5 inline-block mr-1 -mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 10h16M4 14h16M4 18h16"/></svg>
              Table
            </button>
            <button id="viewGrid" onclick="setView('grid')" class="btn-press px-3 py-1.5 text-xs font-semibold rounded-full text-slate-500 active:scale-95 transition-all">
      ...
      <div class="bg-white rounded-2xl border border-slate-100 overflow-hidden shadow-sm">
          ...
          <table class="w-full text-sm" id="empTable">
            <thead>
              <tr class="border-b border-slate-100 bg-slate-50/60">
                ...
                <th class="text-left px-4 py-3 text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap cursor-pointer hover:text-slate-700 select-none" onclick="sortTable(1)">Name ↕</th>
                <th class="text-left px-4 py-3 text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">Email</th>
                <th class="text-left px-4 py-3 text-xs font-semibold text-slate-400 uppercase tracking-wide cursor-pointer hover:text-slate-700 select-none" onclick="sortTable(3)">Sales ↕</th>
                <th class="text-left px-4 py-3 text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap cursor-pointer hover:text-slate-700 select-none" onclick="sortTable(4)">Date ↕</th>
                <th class="text-left px-4 py-3 text-xs font-semibold text-slate-400 uppercase tracking-wide">Status</th>
                <th class="text-left px-4 py-3 text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">Company</th>
                <th class="px-4 py-3 w-16"></th>
              </tr>
            </thead>
            <tbody class="divide-y divide-slate-50" id="empBody">
              <!-- Active -->
              <tr class="emp-row cursor-pointer" data-status="active"><td class="px-4 py-3.5"><input type="checkbox" class="row-check rounded border-slate-300 w-4 h-4 cursor-pointer"></td><td class="px-4 py-3.5 font-semibold emp-name text-slate-800 whitespace-nowrap">Cody Fisher</td><td class="px-4 py-3.5 text-slate-500 text-xs">Rambunctious@gmail.com</td><td class="px-4 py-3.5 font-semibold text-slate-700" style="font-family:'DM Mono',monospace">426</td><td class="px-4 py-3.5 text-slate-500 text-xs whitespace-nowrap" style="font-family:'DM Mono',monospace">Aug 24, 2022</td><td class="px-4 py-3.5"><span class="text-xs font-semibold px-2.5 py-1 rounded-full bg-emerald-50 text-emerald-700 border border-emerald-200">Active</span></td><td class="px-4 py-3.5 text-slate-600 text-xs whitespace-nowrap">Soylent Corp</td><td class="px-4 py-3.5 text-right"><button class="view-btn btn-press text-xs font-semibold text-blue-600 border border-blue-200 bg-blue-50 hover:bg-blue-100 px-2.5 py-1 rounded-full active:scale-95 transition-all">View</button></td></tr>
              <tr class="emp-row cursor-pointer" data-status="active"><td class="px-4 py-3.5"><input type="checkbox" class="row-check rounded border-slate-300 w-4 h-4 cursor-pointer"></td><td class="px-4 py-3.5 font-semibold emp-name text-slate-800 whitespace-nowrap">Bessie Cooper</td><td class="px-4 py-3.5 text-slate-500 text-xs">TheAmbitiousGamer@gmail.com</td><td class="px-4 py-3.5 font-semibold text-slate-700" style="font-family:'DM Mono',monospace">196</td><td class="px-4 py-3.5 text-slate-500 text-xs whitespace-nowrap" style="font-family:'DM Mono',monospace">Aug 24, 2022</td><td class="px-4 py-3.5"><span class="text-xs font-semibold px-2.5 py-1 rounded-full bg-emerald-50 text-emerald-700 border border-emerald-200">Active</span></td><td class="px-4 py-3.5 text-slate-600 text-xs whitespace-nowrap">Sterling Cooper</td><td class="px-4 py-3.5 text-right"><button class="view-btn btn-press text-xs font-semibold text-blue-600 border border-blue-200 bg-blue-50 hover:bg-blue-100 px-2.5 py-1 rounded-full active:scale-95 transition-all">View</button></td></tr>
              <!-- Pending -->
              <tr class="emp-row cursor-pointer" data-status="pending"><td class="px-4 py-3.5"><input type="checkbox" class="row-check rounded border-slate-300 w-4 h-4 cursor-pointer"></td><td class="px-4 py-3.5 font-semibold emp-name text-slate-800 whitespace-nowrap">Cameron Williamson</td><td class="px-4 py-3.5 text-slate-500 text-xs">Idiotic@gmail.com</td><td class="px-4 py-3.5 font-semibold text-slate-700" style="font-family:'DM Mono',monospace">429</td><td class="px-4 py-3.5 text-slate-500 text-xs whitespace-nowrap" style="font-family:'DM Mono',monospace">Aug 24, 2022</td><td class="px-4 py-3.5"><span class="text-xs font-semibold px-2.5 py-1 rounded-full bg-amber-50 text-amber-700 border border-amber-200">Pending</span></td><td class="px-4 py-3.5 text-slate-600 text-xs whitespace-nowrap">Plexzap</td><td class="px-4 py-3.5 text-right"><button class="view-btn btn-press text-xs font-semibold text-blue-600 border border-blue-200 bg-blue-50 hover:bg-blue-100 px-2.5 py-1 rounded-full active:scale-95 transition-all">View</button></td></tr>
              <tr class="emp-row cursor-pointer" data-status="active"><td class="px-4 py-3.5"><input type="checkbox" class="row-check rounded border-slate-300 w-4 h-4 cursor-pointer"></td><td class="px-4 py-3.5 font-semibold emp-name text-slate-800 whitespace-nowrap">Darlene Robertson</td><td class="px-4 py-3.5 text-slate-500 text-xs">Spicy@gmail.com</td><td class="px-4 py-3.5 font-semibold text-slate-700" style="font-family:'DM Mono',monospace">154</td><td class="px-4 py-3.5 text-slate-500 text-xs whitespace-nowrap" style="font-family:'DM Mono',monospace">Aug 24, 2022</td><td class="px-4 py-3.5"><span class="text-xs font-semibold px-2.5 py-1 rounded-full bg-emerald-50 text-emerald-700 border border-emerald-200">Active</span></td><td class="px-4 py-3.5 text-slate-600 text-xs whitespace-nowrap">Initech</td><td class="px-4 py-3.5 text-right"><button class="view-btn btn-press text-xs font-semibold text-blue-600 border border-blue-200 bg-blue-50 hover:bg-blue-100 px-2.5 py-1 rounded-full active:scale-95 transition-all">View</button></td></tr>
              <!-- Error -->
              <tr class="emp-row cursor-pointer" data-status="error"><td class="px-4 py-3.5"><input type="checkbox" class="row-check rounded border-slate-300 w-4 h-4 cursor-pointer"></td><td class="px-4 py-3.5 font-semibold emp-name text-slate-800 whitespace-nowrap">Jane Cooper</td><td class="px-4 py-3.5 text-slate-500 text-xs">Interesting@gmail.com</td><td class="px-4 py-3.5 font-semibold text-slate-700" style="font-family:'DM Mono',monospace">826</td><td class="px-4 py-3.5 text-slate-500 text-xs whitespace-nowrap" style="font-family:'DM Mono',monospace">Aug 24, 2022</td><td class="px-4 py-3.5"><span class="text-xs font-semibold px-2.5 py-1 rounded-full bg-red-50 text-red-600 border border-red-200">Error</span></td><td class="px-4 py-3.5 text-slate-600 text-xs whitespace-nowrap">J-Texan</td><td class="px-4 py-3.5 text-right"><button class="view-btn btn-press text-xs font-semibold text-blue-600 border border-blue-200 bg-blue-50 hover:bg-blue-100 px-2.5 py-1 rounded-full active:scale-95 transition-all">View</button></td></tr>
              <tr class="emp-row cursor-pointer" data-status="active"><td class="px-4 py-3.5"><input type="checkbox" class="row-check rounded border-slate-300 w-4 h-4 cursor-pointer"></td><td class="px-4 py-3.5 font-semibold emp-name text-slate-800 whitespace-nowrap">Guy Hawkins</td><td class="px-4 py-3.5 text-slate-500 text-xs">Cynical@gmail.com</td><td class="px-4 py-3.5 font-semibold text-slate-700" style="font-family:'DM Mono',monospace">883</td><td class="px-4 py-3.5 text-slate-500 text-xs whitespace-nowrap" style="font-family:'DM Mono',monospace">Aug 24, 2022</td><td class="px-4 py-3.5"><span class="text-xs font-semibold px-2.5 py-1 rounded-full bg-emerald-50 text-emerald-700 border border-emerald-200">Active</span></td><td class="px-4 py-3.5 text-slate-600 text-xs whitespace-nowrap">Bubba Gump</td><td class="px-4 py-3.5 text-right"><button class="view-btn btn-press text-xs font-semibold text-blue-600 border border-blue-200 bg-blue-50 hover:bg-blue-100 px-2.5 py-1 rounded-full active:scale-95 transition-all">View</button></td></tr>
              <!-- Inactive -->
              <tr class="emp-row cursor-pointer" data-status="inactive"><td class="px-4 py-3.5"><input type="checkbox" class="row-check rounded border-slate-300 w-4 h-4 cursor-pointer"></td><td class="px-4 py-3.5 font-semibold emp-name text-slate-800 whitespace-nowrap">Eleanor Pena</td><td class="px-4 py-3.5 text-slate-500 text-xs">Drob@gmail.com</td><td class="px-4 py-3.5 font-semibold text-slate-700" style="font-family:'DM Mono',monospace">130</td><td class="px-4 py-3.5 text-slate-500 text-xs whitespace-nowrap" style="font-family:'DM Mono',monospace">Aug 24, 2022</td><td class="px-4 py-3.5"><span class="text-xs font-semibold px-2.5 py-1 rounded-full bg-slate-100 text-slate-500 border border-slate-200">InActive</span></td><td class="px-4 py-3.5 text-slate-600 text-xs whitespace-nowrap">Duff Beer</td><td class="px-4 py-3.5 text-right"><button class="view-btn btn-press text-xs font-semibold text-blue-600 border border-blue-200 bg-blue-50 hover:bg-blue-100 px-2.5 py-1 rounded-full active:scale-95 transition-all">View</button></td></tr>
              <tr class="emp-row cursor-pointer" data-status="active"><td class="px-4 py-3.5"><input type="checkbox" class="row-check rounded border-slate-300 w-4 h-4 cursor-pointer"></td><td class="px-4 py-3.5 font-semibold emp-name text-slate-800 whitespace-nowrap">Esther Howard</td><td class="px-4 py-3.5 text-slate-500 text-xs">Stimulating@gmail.com</td><td class="px-4 py-3.5 font-semibold text-slate-700" style="font-family:'DM Mono',monospace">703</td><td class="px-4 py-3.5 text-slate-500 text-xs whitespace-nowrap" style="font-family:'DM Mono',monospace">Aug 24, 2022</td><td class="px-4 py-3.5"><span class="text-xs font-semibold px-2.5 py-1 rounded-full bg-emerald-50 text-emerald-700 border border-emerald-200">Active</span></td><td class="px-4 py-3.5 text-slate-600 text-xs whitespace-nowrap">Hooli</td><td class="px-4 py-3.5 text-right"><button class="view-btn btn-press text-xs font-semibold text-blue-600 border border-blue-200 bg-blue-50 hover:bg-blue-100 px-2.5 py-1 rounded-full active:scale-95 transition-all">View</button></td></tr>
              <!-- Extra rows -->
              <tr class="emp-row cursor-pointer" data-status="active"><td class="px-4 py-3.5"><input type="checkbox" class="row-check rounded border-slate-300 w-4 h-4 cursor-pointer"></td><td class="px-4 py-3.5 font-semibold emp-name text-slate-800 whitespace-nowrap">Staff Name</td><td class="px-4 py-3.5 text-slate-500 text-xs">staffname@gmail.com</td><td class="px-4 py-3.5 font-semibold text-slate-700" style="font-family:'DM Mono',monospace">XXX</td><td class="px-4 py-3.5 text-slate-500 text-xs whitespace-nowrap" style="font-family:'DM Mono',monospace">mm-dd-yyyy</td><td class="px-4 py-3.5"><span class="text-xs font-semibold px-2.5 py-1 rounded-full bg-emerald-50 text-emerald-700 border border-emerald-200">Active</span></td><td class="px-4 py-3.5 text-slate-600 text-xs whitespace-nowrap">Company Name</td><td class="px-4 py-3.5 text-right"><button class="view-btn btn-press text-xs font-semibold text-blue-600 border border-blue-200 bg-blue-50 hover:bg-blue-100 px-2.5 py-1 rounded-full active:scale-95 transition-all">View</button></td></tr>
              <tr class="emp-row cursor-pointer" data-status="pending"><td class="px-4 py-3.5"><input type="checkbox" class="row-check rounded border-slate-300 w-4 h-4 cursor-pointer"></td><td class="px-4 py-3.5 font-semibold emp-name text-slate-800 whitespace-nowrap">Staff Name</td><td class="px-4 py-3.5 text-slate-500 text-xs">staffname@gmail.com</td><td class="px-4 py-3.5 font-semibold text-slate-700" style="font-family:'DM Mono',monospace">XXX</td><td class="px-4 py-3.5 text-slate-500 text-xs whitespace-nowrap" style="font-family:'DM Mono',monospace">mm-dd-yyyy</td><td class="px-4 py-3.5"><span class="text-xs font-semibold px-2.5 py-1 rounded-full bg-amber-50 text-amber-700 border border-amber-200">Pending</span></td><td class="px-4 py-3.5 text-slate-600 text-xs whitespace-nowrap">Company Name</td><td class="px-4 py-3.5 text-right"><button class="view-btn btn-press text-xs font-semibold text-blue-600 border border-blue-200 bg-blue-50 hover:bg-blue-100 px-2.5 py-1 rounded-full active:scale-95 transition-all">View</button></td></tr>
            </tbody>
          </table>
        </div>
        ...
        <div class="flex items-center justify-between px-5 py-3.5 border-t border-slate-100 flex-wrap gap-3">
          <p class="text-xs text-slate-500">Showing <span class="font-semibold text-slate-700">1–10</span> of <span class="font-semibold text-slate-700">XX</span> employees</p>
          <div class="flex items-center gap-1">
            ...
            <button class="btn-press w-8 h-8 flex items-center justify-center rounded-lg border border-slate-200 text-xs font-medium hover:bg-slate-50 transition-all active:scale-95">2</button>
            <button class="btn-press w-8 h-8 flex items-center justify-center rounded-lg border border-slate-200 text-xs font-medium hover:bg-slate-50 transition-all active:scale-95">3</button>
            <span class="w-8 h-8 flex items-center justify-center text-xs text-slate-400">...</span>
            <button class="btn-press w-8 h-8 flex items-center justify-center rounded-lg border border-slate-200 text-xs font-medium hover:bg-slate-50 transition-all active:scale-95">5</button>
...
<script>
  ...
  document.addEventListener('click', e => {
    ...
    if (!w.contains(e.target)) { document.getElementById('profileDropdown').classList.remove('open'); document.getElementById('profileChevron').style.transform = ''; }
  });
